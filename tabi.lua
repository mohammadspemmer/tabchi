...
if msg.content.text == "#stats" or msg.content.text == "امار بده" and is_admin(msg) then 
...
▪️ای اف 
▫️کانال: @AFBoTS
▫️سایت: https://AFBoTS.ir
▫توسعه دهنده: @AFProgrammer
...
#setfwdtime
[ تنظیم فاصله ارسال خودکار بنر در گروه ها (توجه داشته باشید که باید با ثانیه باشد مثلا 1800 )] 
#autofwd [on,off]
ارسال خودکار آخرین بنر ارسال شده در گروه ها و پی وی های جدید
#setbaner [reply] 
...
#autorandom [on,off]
ارسال خودکار بنر های تنظیم شده در گروه ها و پی وی های ربات با زمان فاصله ای که تنظیم کرده باشید 
توجه داشته باشید که قبل از فعال کردن حتما فاصله ارسال را تنظیم کنید در غیر صورت ربات ارسال نخواهد کرد!
#tableft [on,off]
